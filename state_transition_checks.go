...
func TransitionState(state_balances map[string]map[string]string, transactions []Transaction, currencies []string) (map[string]map[string]string, HasProcess, map[string]bool, map[string]uint64, error) {
